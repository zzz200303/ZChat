...
import (
	"ZChat/apps/single-chat/api/internal/handler/chatconn"
	"flag"
	"fmt"
	"github.com/zeromicro/go-zero/core/logx"

	"ZChat/apps/single-chat/api/internal/config"
	"ZChat/apps/single-chat/api/internal/handler"
...
var configFile = flag.String("f", "etc/singlechat-api.yaml", "the config file")
